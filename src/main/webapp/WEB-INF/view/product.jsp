...
<html>
	<head>
		...
		<script  src="https://ajax.googleapis.com/ajax/libs/anjularjs/1.0.1/angular.min.js"></script>
		<script src="/teahouse/resource/js/controllers.js"></script>
		...
		<section class="container" ng-app="cartApp">
			<div class="row">
				...
				<div class="col-md-5">
					...
					<p ng-controller="cartCtrl"><a href="#" class="btn btn-warning btn-large" ng-click="addToCart('${product.productId}')"> <span class="glyphicon-shopping-cart glyphicon"></span> Order Now</a>
